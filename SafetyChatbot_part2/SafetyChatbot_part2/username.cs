    ...
    {// start of class user_name 
        ...
        {//start of
            ...
            {//start of if
                ...
                error_method("SafetyBotAnator", "Hey " + name + "  welcome to AI cybersecurity", chats);
            ...
            {//start of else
                ...
                error_method("SafetyBotAnator ", "Hey " + name + " welcome back, how can i help you today", chats);
        ...
        {//star of error mehtod
            ...
            Brush nameColor = (name.ToLower().Contains("SafetyBotAnator") || name.ToLower().Contains("chat")) ?
